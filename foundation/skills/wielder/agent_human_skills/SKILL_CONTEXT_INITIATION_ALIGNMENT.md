...
4. Load configuration ecology.
   - Read [SKILL_CONFIGURATION_GUIDELINES.md](../config_skills/SKILL_CONFIGURATION_GUIDELINES.md) as part of initiation.
   - Read [SKILL_EPIGENETIC_CONFIG_CONTRACTS.md](../config_skills/SKILL_EPIGENETIC_CONFIG_CONTRACTS.md) as part of initiation to ground the Wieldering Way: versioned HOCON contracts feed strict library validation, not hand-built descriptors or defensive defaults.
