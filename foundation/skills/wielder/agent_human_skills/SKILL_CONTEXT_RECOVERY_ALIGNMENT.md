...
2. Produce a doctrine-level Concise Alignment Summary.
   ...
   - Read the relevant Wielder Antifragile foundation files, starting with:
     ...
     - [foundation/skills/wielder/agent_human_skills/SKILL_OPERATOR_ALIGNMENT.md](SKILL_OPERATOR_ALIGNMENT.md)
     - [foundation/skills/wielder/architecture_skills/SKILL_SCOPE_GUIDELINES.md](../architecture_skills/SKILL_SCOPE_GUIDELINES.md)
