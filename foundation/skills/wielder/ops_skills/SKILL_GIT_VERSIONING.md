...
- Do not encode mode decisions in commit commands, ad hoc CLI flags, or narrow Python helpers when the [Configuration & Datastore Lineage](../config_skills/SKILL_CONFIGURATION_GUIDELINES.md) skill says they belong in config.
